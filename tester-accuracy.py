...
perpleFile = "PerpLETestSuitesChecked/x86unfenced-accuracy/" + testname + "/num_reads.perple"
checkerFile = "PerpLETestSuitesChecked/x86unfenced-accuracy/" + testname + "/checker.c"
checkerHeuristicFile = "PerpLETestSuitesChecked/x86unfenced-accuracy/" + testname + "/checker-heuristic.c"
...
threadfilenames = "./PerpLETestSuitesChecked/x86unfenced-accuracy/" + testname + "/" + testname + "_thread_*"
subprocess.call("gcc -fopenmp -o " + execfilename + " integratedHarnessAccuracy.c " + threadfilenames, shell=True)
# Open output file
...
# create folder
pathname = "./PerpLEResults/x86tso-accuracy/" + testname
print(pathname)
try:
...
# Open summary file
summfilename = "./PerpLEResults/x86tso-accuracy/" + testname + "/" + "summary_" + testname + "_" + now.strftime("%Y-%m-%d_%H:%M:%S")
