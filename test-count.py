...
perpleFile = "PerpLETestSuitesChecked/x86tso-multi/" + testname + "/num_reads.perple"
checkerFile = "PerpLETestSuitesChecked/x86tso-multi/" + testname + "/checker.c"
checkerHeuristicFile = "PerpLETestSuitesChecked/x86tso-multi/" + testname + "/checker-heuristic.c"
...
threadfilenames = "./PerpLETestSuitesChecked/x86tso-multi/" + testname + "/" + litmusname + "_thread_*"
...
# create folder
pathname = "./PerpLEResults/x86tso-multi/" + testname
print(pathname)
try:
