set terminal postscript enhanced color solid eps size 10,3 font "arial,14" 
set output 'speedup-100k.eps'
...
plot 'speedup-100k.csv' using 2:xtic(1) title columnheader(2) ls 1, \
